...
export declare class gig extends sync {
    constructor(sync: sync, securedOption?: ChargedOption<chargingParams>, fixedPrice?: number, initiatiors?: [], funds?: fundingParams, withdrawals?: withdrawalParams, cancelation?: cancelationParams, purchasingStatus?: purchasingParams);
